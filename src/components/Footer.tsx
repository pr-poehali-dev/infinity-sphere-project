      ...
      <div className="container mx-auto px-4 md:px-12">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-sm">Кухни на заказ в Новокузнецке. Проектируем, изготавливаем и монтируем — от замера до последней ручки на фасаде.</p>
          </div>
        ...
        <div className="pt-8 border-t border-border mb-8">
          <div className="text-sm text-muted-foreground leading-relaxed space-y-3 max-w-4xl">
            <p>Кухни на заказ в Новокузнецке от производителя — изготавливаем и устанавливаем кухонные гарнитуры под ключ за 35 дней. Работаем во всех районах обоих городов. Бесплатный замер, дизайн-проект с 3D-визуализацией и точный расчёт стоимости до начала работ.</p>
            <p>
              ...
              рассрочка. Закажите кухню мечты в Кемерово или Новокузнецке — оставьте заявку, и мы свяжемся с вами в течение 15 минут.
            </p>
          </div>
        </div>
