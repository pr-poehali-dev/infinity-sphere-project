...
const packages = [
  {
    ...
    description: "Дёшево и сердито — именно так. Стильный внешний вид из доступных материалов для тех, кто умеет считать деньги.",
    price: "от 180 000 ₽",
  ...
  },
  {
    ...
    description: "Современная кухня с дизайн-проектом. Цена = Качество — лучшее решение для тех, кто хочет кухню один раз и надолго.",
    price: "от 280 000 ₽",
    features: ["Дизайн-проект + 3D-визуализация", "Фасады МДФ-Пластик или Эмаль", "Столешница HPL или акрил", "Встроенная техника −30%", "Система хранения", "Авторский надзор"],
    featured: true,
  },
  {
    name: "ТОПОВЫЙ",
