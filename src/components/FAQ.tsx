...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Да, замер бесплатный. На основе замеров разрабатываем 3D-визуализацию, согласовываем каждый элемент — и только потом запускаем производство. Вы видите точный результат до начала работ.",
  },
  {
