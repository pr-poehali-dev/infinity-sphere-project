...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Работаем по всему Кемерово (Центральный, Ленинский, Заводский, Кировский, Рудничный) и по всему Новокузнецку. Выезжаем на замер по обоим городам и в пригород бесплатно.",
  },
  {
