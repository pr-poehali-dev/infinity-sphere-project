...
const faqs = [
  {
    ...
    answer:
      "Стоимость зависит от размера, материалов и конфигурации. Кухня эконом-класса — от 180 000 ₽, среднего сегмента — от 250 000 ₽, премиум — от 500 000 ₽. Точную сумму рассчитываем после замера и обсуждения вашего проекта.",
  },
  {
